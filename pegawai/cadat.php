...
<!-- Content Wrapper. Contains page content -->
  <!-- ============================================================== -->
    ...
    <div class="container-fluid">
      ...
      $adat = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM adat"));
      ?>
    <!-- ============================================================== -->
    <!-- Start Page Content -->
    <!-- ============================================================== -->
        ...
        <div class="col-4">
          <div class="card">
            <div class="card-body">
              <?php $qrytahun = mysqli_query($koneksi, "SELECT * FROM adat INNER JOIN daerah ON adat.id_d=daerah.id_d GROUP BY YEAR(tgl_adat) ASC"); ?>
              
                  <form action="../dt/data_adat.php" method="post" target="_blank"> 
                    <table>
                            ...
                            <label class="form-label">Berdasarkan Tahun</label>
                              <div class="" style="margin-bottom: 10px;">
                                <select style="color: black;" name="tahun-cetak" class="form-control">
                                  ...
                                  <option><?php $formatwaktu = $row["tgl_adat"];echo date('Y',strtotime($formatwaktu)); ?></option>
                                  <?php } ?>
                                  <?php } ?>
                                </select>
                              </div>
                          ...
                          <a title="Cetak Semua Data" href="../dt/data_adat.php?id_adat=<?php echo $row['id_adat']; ?>" class="btn btn-dark" target="_blank"><i class="mdi mdi-check-all font-22"></i></a>
                        </div>
                </form>
              </div>
            </div>
