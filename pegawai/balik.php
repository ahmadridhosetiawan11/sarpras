                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <tr >
                          ...
                          $no = 1;
                          $nip=$user_row['nip'];
                          $sql = mysqli_query($koneksi,"SELECT * FROM pengembalian INNER JOIN peminjaman ON pengembalian.id_peminjaman=peminjaman.id_peminjaman INNER JOIN pegawai ON pengembalian.id_pegawai=pegawai.id_pegawai WHERE nip='$nip'");
