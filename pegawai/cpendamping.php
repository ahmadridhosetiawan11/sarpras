...
<!-- Content Wrapper. Contains page content -->
  <!-- ============================================================== -->
    ...
    <div class="container-fluid">
      ...
      $pendamping = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pendamping"));
      ?>
    <!-- ============================================================== -->
    <!-- Start Page Content -->
    <!-- ============================================================== -->
      <div class="row">
        ...
        <div class="col-4">
          <div class="card">
            <div class="card-body">
              <?php $qrytahun = mysqli_query($koneksi, "SELECT * FROM pendamping GROUP BY YEAR(tgl_pd) ASC"); ?>
                  <form action="../dt/data_pendamping.php" method="post" target="_blank"> 
                    <table>
                      ...
                      <a title="Cetak Semua Data" href="../dt/data_pendamping.php?id_pd=<?php echo $row['id_pd']; ?>" class="btn btn-dark" target="_blank"><i class="mdi mdi-check-all font-22"></i></a>
                    </div>
                  </form>
                </div>
              </div>
