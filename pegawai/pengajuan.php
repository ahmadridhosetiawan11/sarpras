                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <tr >
                          ...
                          $no = 1;
                          $nip=$user_row['nip'];
                          $sql = mysqli_query($koneksi,"SELECT * FROM pengajuan INNER JOIN sarpras ON pengajuan.id_sarpras = sarpras.id_sarpras INNER JOIN pegawai ON pengajuan.id_pegawai = pegawai.id_pegawai WHERE nip='$nip'");
