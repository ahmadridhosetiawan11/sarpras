...
if (!isset($_SESSION['id_pegawai']) || (trim($_SESSION['id_pegawai']) == '')) { ?>
<script>
window.location = "../";
</script>
<?php 
}
$session_id=$_SESSION['id_pegawai'];

$user_query = mysqli_query($koneksi, "SELECT * FROM pegawai WHERE id_pegawai = '$session_id'")or die(mysqli_error($koneksi));
            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Informasi Sarpras Tersedia </span></a
                >
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Daftar Peminjaman</span></a
                >
              </li>
              ...
              <!-- <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Denda Peminjaman</span></a
                >
              </li> -->
