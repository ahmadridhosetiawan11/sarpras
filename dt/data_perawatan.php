...
<div class="tujuan">
  ...
  <div class="container">
  <h2 class="text-center">DAFTAR DATA PERAWATAN SARPRAS</h2>
...
$no = 1;
      while($data = mysqli_fetch_array($result)) {?>
          <tr class="text-center">
            ...
            <td style="vertical-align: middle;"><?php echo tgl_indo($data['tgl_sl']) ?></td>
            <td style="vertical-align: middle;"><?php echo $data['jml_prw'] ?></td>
