    ...
    <body>
        <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                ...
                <span class="site-heading-lower">Dinas Pemberdayaan Masyarakat dan Desa</span>
            </h1>
        </header>
        <!-- Navigation-->
        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="dist/img/products-01.jpg" alt="..." />
        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="dist/img/products-02.jpg" alt="..." />
        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="dist/img/products-03.jpg" alt="..." />
                    <div class="product-item-description d-flex me-auto">
