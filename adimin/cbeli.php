...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="container-fluid">
    ...
    $beli = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM beli"));
    ?>
  <!-- ============================================================== -->
  <!-- Start Page Content -->
  <!-- ============================================================== -->
      ...
      <div class="col-md-6 col-lg-2 col-xlg-3">
        <div class="card card-hover">
          <div class="box bg-info text-center">
            ...
            <h4 class="text-white">Jumlah Semua Data : <?= $beli ?></h4>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-2 col-xlg-3">
          <div class="card card-hover">
            <div class="card-body">
              <form action="../dt/data_beli.php" method="post" target="_blank">
        ...
        <div class="col-4">
          <div class="card">
            <div class="card-body">
              <?php $qrytahun = mysqli_query($koneksi, "SELECT * FROM beli GROUP BY YEAR(tgl_b) ASC"); ?>
                  <form action="../dt/data_beli.php" method="post" target="_blank"> 
                    <table>
                      <label class="form-label" >Berdasarkan Bulan</label>
                        <div class="" style="margin-bottom: 10px;">
                          <select name="bulan-cetak" class="form-control select2">
                            <?php
                              $ahay = mysqli_query($koneksi, "SELECT DISTINCT MONTH(tgl_b) as bulan FROM beli ORDER BY bulan ASC");
