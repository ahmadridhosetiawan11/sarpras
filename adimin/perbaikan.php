<?php require_once("head.php");require_once("../koneksi.php");require_once("../fungsi_indotgl.php");require_once("../fungsi_rupiah.php"); ?>
                      ...
                      <div class="card-body">
                        ...
                        <tr >
                          ...
                          <td id="ikonbtn2" style="vertical-align: middle;">
                            <?php
                              if($data['status_pbk']=='Sedang Dalam Perbaikan'){?>
  ...
  if (isset($_POST['sub'])) {
    ...
    $etdah = mysqli_query($koneksi, "SELECT jml_perbaikan FROM sarpras WHERE id_sarpras = '$id_sarpras'");
    $asoy = mysqli_fetch_array($etdah);
    ...
    $ayam = mysqli_query($koneksi, "SELECT jml_rusak FROM sarpras WHERE id_sarpras = '$id_sarpras'");
    $ihiy = mysqli_fetch_array($ayam);
    $asu = $ihiy['jml_rusak'] - $jml_pbk;

      if($update){
        $asee = mysqli_query($koneksi, "UPDATE sarpras SET jml = '$totaljumlah' WHERE id_sarpras = '$id_sarpras'");
      $xx = mysqli_query($koneksi, "UPDATE sarpras SET kode_sarpras = 'SPADA' WHERE id_sarpras = '$id_sarpras'");
      $xx = mysqli_query($koneksi, "UPDATE rusak SET jml_rk = 'udeh' WHERE id_sarpras = '$id_sarpras'");
      $xixi = mysqli_query($koneksi, "UPDATE sarpras SET jml_rusak = '$asu' WHERE id_sarpras = '$id_sarpras'");
