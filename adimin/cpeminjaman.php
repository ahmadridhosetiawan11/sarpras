<?php require_once("head.php"); require_once("../fungsi_indotgl.php"); require_once("../fungsi_rupiah.php");require_once("../koneksi.php"); ?>
    ...
    <div class="row">
      <div class="col-md-6 col-lg-2 col-xlg-3">
        <div class="card card-hover">
          <div class="box bg-info text-center">
            ...
            <h4 class="text-white">Jumlah Semua Data : <?= $peminjaman ?></h4>
          </div>
        </div>
      </div>
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
              <div class="card-body">
                <form action="../dt/data_peminjaman.php" method="post" target="_blank">
      ...
      <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
              <div class="card-body">
                <form action="../dt/data_peminjaman.php" method="post" target="_blank">
                  <label class="form-label">Berdasarkan Tanggal Meminjam</label>
                    <div class="" style="margin-bottom: 10px;">
                      <input type="date" class="form-control" name="tgl_minjem" required>
                    </div>
                    <div class="" style="margin-bottom: 10px;">
                      <select style="color: black;" name="ttd" class="form-control select2" required="">
                        <?php $asw = mysqli_query($koneksi, "SELECT * FROM pegawai GROUP BY nama_lengkap ASC"); ?>
      ...
      <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
              <div class="card-body">
                <form action="../dt/data_peminjaman.php" method="post" target="_blank">
                  <label class="form-label">Berdasarkan Tanggal Kembali</label>
                    <div class="" style="margin-bottom: 10px;">
                      <input type="date" class="form-control" name="tgl_balik" required>
                    </div>
                    <div class="" style="margin-bottom: 10px;">
                      <select style="color: black;" name="ttd" class="form-control select2" required="">
                        <?php $asw = mysqli_query($koneksi, "SELECT * FROM pegawai GROUP BY nama_lengkap ASC"); ?>
        ...
        <div class="col-4">
          <div class="card">
            <div class="card-body">
              <?php $qrytahun = mysqli_query($koneksi, "SELECT * FROM peminjaman INNER JOIN pengajuan ON peminjaman.id_pengajuan=pengajuan.id_pengajuan INNER JOIN sarpras ON peminjaman.nama_s=sarpras.nama_s INNER JOIN pegawai ON pengajuan.id_pegawai=pegawai.id_pegawai GROUP BY YEAR(tgl_pmj) ASC"); ?>
                  <form action="../dt/data_peminjaman.php" method="post" target="_blank"> 
                    <table>
                      <label class="form-label" >Berdasarkan Bulan</label>
                        <div class="" style="margin-bottom: 10px;">
                          <select name="bulan-cetak" class="form-control select2">
                            <?php
                              $ahay = mysqli_query($koneksi, "SELECT DISTINCT MONTH(tgl_pmj) as bulan FROM peminjaman ORDER BY bulan ASC");
                        ...
                        <label class="form-label">Berdasarkan Tahun</label>
                          <div class="" style="margin-bottom: 10px;">
                            <select style="color: black;" name="tahun-cetak" class="form-control select2" required="">
                              ...
                              <option><?php $formatwaktu = $row["tgl_pmj"];echo date('Y',strtotime($formatwaktu)); ?></option>
                              <?php } ?>
                              <?php } ?>
                            </select>
                          </div>
