...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="container-fluid">
    ...
    $rusak = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM aset"));
    ?>
  <!-- ============================================================== -->
  <!-- Start Page Content -->
  <!-- ============================================================== -->
    <div class="row">
      <div class="col-md-6 col-lg-2 col-xlg-3">
        <div class="card card-hover">
          <div class="box bg-info text-center">
            ...
            <h4 class="text-white">Jumlah Semua Data : <?= $rusak ?></h4>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
              <div class="card-body">
                <form action="../dt/data_aset.php" method="post" target="_blank">
      ...
      <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
              <div class="card-body">
                <form action="../dt/data_aset.php" method="post" target="_blank">
                  <label class="form-label">Cetak Data</label>
                    <div class="" style="margin-bottom: 10px;">
                      <select style="color: black;" name="status_aset" class="form-control select2" required="">
                        <?php $asek = mysqli_query($koneksi, "SELECT * FROM aset GROUP BY status_aset ASC"); ?>
                        <?php while ($asu = mysqli_fetch_array($asek)) { ?>
                        <option value="<?= $asu["status_aset"]; ?>"><?php echo $asu["status_aset"]; ?></option>
                        <?php } ?>
                      </select>
                    </div>
        ...
        <div class="col-4">
          <div class="card">
            <div class="card-body">
              <?php $qrytahun = mysqli_query($koneksi, "SELECT * FROM aset GROUP BY YEAR(tgl_aset) ASC"); ?>
                  <form action="../dt/data_aset.php" method="post" target="_blank"> 
                    <table>
                      <label class="form-label" >Berdasarkan Bulan</label>
                        <div class="" style="margin-bottom: 10px;">
                          <select name="bulan-cetak" class="form-control select2">
                            <?php
                              $ahay = mysqli_query($koneksi, "SELECT DISTINCT MONTH(tgl_aset) as bulan FROM aset ORDER BY bulan ASC");
                        ...
                        <label class="form-label">Berdasarkan Tahun</label>
                          <div class="" style="margin-bottom: 10px;">
                            <select style="color: black;" name="tahun-cetak" class="form-control select2">
                              ...
                              <option><?php $formatwaktu = $row["tgl_aset"];echo date('Y',strtotime($formatwaktu)); ?></option>
                              <?php } ?>
                              <?php } ?>
                            </select>
                          </div>
