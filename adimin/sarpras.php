              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <tr >
                    ...
                    <!-- <td>
                     <p>Sedang Dipinjam : <?php echo $data['jml'] ?></p>
                      <p>Rusak : <?php echo $data['jml_rusak'] ?></p>
                      <p>Dalam Perbaikan : <?php echo $data['jml_perbaikan'] ?></p>
                    </td> -->
                    <td><?php 
                        if($data['jml']==0){
                    ...
                    <td id="ikonbtn2">
                      <a title="Edit Data?" name="id_sarpras" href="sarpras_ed.php?id_sarpras=<?php echo $data['id_sarpras']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-exclamation-triangle"></i></a>
                      <a href="sarpras_hp.php?id_sarpras=<?php echo $data['id_sarpras']; ?>" class="btn btn-danger btn-sm" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
