...
<!-- Content Wrapper. Contains page content -->
  <!-- ============================================================== -->
    ...
    <div class="container-fluid">
      ...
      $posbindu = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM perbaikan INNER JOIN sarpras ON perbaikan.id_sarpras=sarpras.id_sarpras"));
      ?>
    <!-- ============================================================== -->
    <!-- Start Page Content -->
    <!-- ============================================================== -->
          ...
          <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
              <div class="box bg-info text-center">
                ...
                <h4 class="text-white">Jumlah Semua Data : <?= $posbindu ?></h4>
              </div>
            </div>
          </div>
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
              <div class="card-body">
                <form action="../dt/data_perbaikan.php" method="post" target="_blank">
        ...
        <div class="col-4">
          <div class="card">
            <div class="card-body">
              <?php $qrytahun = mysqli_query($koneksi, "SELECT * FROM perbaikan INNER JOIN sarpras ON perbaikan.id_sarpras=sarpras.id_sarpras GROUP BY YEAR(tgl_pbk) ASC"); ?>
                  <form action="../dt/data_perbaikan.php" method="post" target="_blank"> 
                    <table>
                      <label class="form-label" >Berdasarkan Bulan</label>
                        <div class="" style="margin-bottom: 10px;">
                          <select name="bulan-cetak" class="form-control select2">
                            <?php
                              $ahay = mysqli_query($koneksi, "SELECT DISTINCT MONTH(tgl_pbk) as bulan FROM perbaikan ORDER BY bulan ASC");
                        ...
                        <label class="form-label">Berdasarkan Tahun</label>
                          <div class="" style="margin-bottom: 10px;">
                            <select style="color: black;" name="tahun-cetak" class="form-control select2">
                              ...
                              <option><?php $formatwaktu = $row["tgl_pbk"];echo date('Y',strtotime($formatwaktu)); ?></option>
                              <?php } ?>
                              <?php } ?>
                            </select>
                          </div>
