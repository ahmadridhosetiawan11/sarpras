              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <a href="sidang_in.php" title="Tambah Data" class="btn btn-success btn-sm mb-3"><i class="mdi mdi-library-plus font-22"></i></a>
                        <a href="sidang_ck.php" name="cetak" target="sidang_ck.php" title="Tambah Data" class="btn btn-info btn-sm mb-3">CETAK DATA</a>
                        ...
                        <tr >
                          ...
                          <td id="ikonbtn2">
                            <a title="Edit Data?" name="id_pegawai" href="sidang_ed.php?id_pegawai=<?php echo $data['id_pegawai']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-exclamation-triangle"></i></a>
                            <a href="sidang_hp.php?id_pegawai=<?php echo $data['id_pegawai']; ?>" class="btn btn-danger btn-sm" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');"><i class="fas fa-trash"></i></a>
                          </td>
                        </tr>
                    <?php } ?>
                  </tbody>
