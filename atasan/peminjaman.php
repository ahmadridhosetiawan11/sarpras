                ...
                <div class="card-body">
                  <!-- <a href="peminjaman_in.php" title="Tambah Data" class="btn btn-success btn-sm mb-3"><i class="mdi mdi-library-plus font-22"></i></a> -->
                      ...
                      <tr >
                        <?php 
                        $no = 1;
                        $sql = mysqli_query($koneksi,"SELECT * FROM peminjaman INNER JOIN pengajuan ON peminjaman.id_pengajuan=pengajuan.id_pengajuan INNER JOIN sarpras ON peminjaman.nama_s=sarpras.nama_s INNER JOIN pegawai ON pengajuan.id_pegawai=pegawai.id_pegawai");
                        ...
                        <td style="vertical-align: middle;"><?php echo $data['status_pjm'] ?></td>

                        <!-- <td id="ikonbtn2" style="vertical-align: middle;">
                        <?php 
                        if($data['status_pjm']=='Sedang Dipinjam'){?>
                        ...
                        <?php }?>
                          <a href="peminjaman_hp.php?id_peminjaman=<?php echo $data['id_peminjaman']; ?>" class="btn btn-danger btn-circle" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');"><i class="fas fa-trash"></i></a>
                        </td> -->
                      </tr>
                  <?php } ?>
                  </tbody>
